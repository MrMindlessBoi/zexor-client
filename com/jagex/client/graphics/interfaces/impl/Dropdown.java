package com.jagex.client.graphics.interfaces.impl;
		...
		public void selectOption(int selected, RSInterface r) {
			switch(selected){
                ...
                case 5://rainbow
					...
					Client.instance.pushMessage("@red@ Warning this could give you seizures! Use at an extreme caution! Zexor not responsible! LoL", 0,"");
                return;
